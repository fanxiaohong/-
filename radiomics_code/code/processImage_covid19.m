function outS = processImage_covid19(filterType,scan3M,mask3M,paramS,hWait)
...
% ·½±ãµ÷ÊÔ£¬¸³Öµ
% filterType = imageTypeC{k}.imageType;
% scan3M = volOrig3M;
% mask3M = maskBoundingBox3M ;
% paramS = imageTypeC{k}.paramS ;
