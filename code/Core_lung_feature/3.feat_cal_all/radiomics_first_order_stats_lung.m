function RadiomicsFirstOrderS = radiomics_first_order_stats_lung(planC,structNum,offsetForEnergy,binWidth)
%
...
RadiomicsFirstOrderS = [];
RadiomicsFirstOrderSmin           = nanmin(Iarray);
RadiomicsFirstOrderSmax           = nanmax(Iarray);
RadiomicsFirstOrderSmean          = nanmean(Iarray);
RadiomicsFirstOrderSrange         = range(Iarray);
RadiomicsFirstOrderSstd           = std(Iarray,1,'omitnan');
RadiomicsFirstOrderSvar           = var(Iarray,1,'omitnan');
RadiomicsFirstOrderSmedian        = nanmedian(Iarray);
...
RadiomicsFirstOrderSskewness      = skewness(Iarray);
...
RadiomicsFirstOrderSkurtosis      = kurtosis(Iarray) - 3;
...
RadiomicsFirstOrderSentropy = entropyV;

%   Root mean square (RMS)
RadiomicsFirstOrderSrms           = sqrt(nansum((Iarray+offsetForEnergy).^2)./sizeV);

%   Energy ( integraal(a^2) )
RadiomicsFirstOrderSenergy   = nansum((Iarray+offsetForEnergy).^2);

%   Total Energy ( voxelVolume * integraal(a^2) )
RadiomicsFirstOrderStotalEnergy   = nansum((Iarray+offsetForEnergy).^2) * VoxelVol;

%   Mean deviation (also called mean absolute deviation)
RadiomicsFirstOrderSmeanAbsDev            = mad(Iarray);

% Median absolute deviation
RadiomicsFirstOrderSmedianAbsDev = nansum(abs(Iarray-RadiomicsFirstOrderSmedian))./sizeV;

%   P10
p10 = prctile(Iarray,10);
RadiomicsFirstOrderSP10 = p10;

%   P90
p90 = prctile(Iarray,90);
RadiomicsFirstOrderSP90 = p90;
...
RadiomicsFirstOrderSrobustMeanAbsDev  = mad(Iarray10_90);

%   Robust Median Absolute Deviation
RadiomicsFirstOrderSrobustMedianAbsDev  = nansum(abs(Iarray10_90-nanmedian(Iarray10_90)))...
    ./ sum(idx10_90);
...
RadiomicsFirstOrderSinterQuartileRange = p75 - p25;

% Quartile coefficient of Dispersion
RadiomicsFirstOrderScoeffDispersion = (p75-p25)./(p75+p25);

% Coefficient of variation
RadiomicsFirstOrderScoeffVariation = RadiomicsFirstOrderSstd ./ RadiomicsFirstOrderSmean;


RadiomicsFirstOrderS = [RadiomicsFirstOrderSmin;RadiomicsFirstOrderSmax;RadiomicsFirstOrderSmean;...
    RadiomicsFirstOrderSrange;RadiomicsFirstOrderSstd;RadiomicsFirstOrderSvar;RadiomicsFirstOrderSmedian;...
    RadiomicsFirstOrderSskewness;RadiomicsFirstOrderSkurtosis;RadiomicsFirstOrderSentropy;RadiomicsFirstOrderSrms;...
    RadiomicsFirstOrderSenergy;RadiomicsFirstOrderStotalEnergy;RadiomicsFirstOrderSmeanAbsDev;...
    RadiomicsFirstOrderSmedianAbsDev;RadiomicsFirstOrderSP10;RadiomicsFirstOrderSP90;...
    RadiomicsFirstOrderSrobustMeanAbsDev;RadiomicsFirstOrderSrobustMedianAbsDev;RadiomicsFirstOrderSinterQuartileRange;...
    RadiomicsFirstOrderScoeffDispersion;RadiomicsFirstOrderScoeffVariation];
end