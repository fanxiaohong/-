function [haralickFeatures] = get_haralick_lung(dirctn, voxelOffset, cooccurType, quantizedM, numGrLevels, glcmFlagS)
...
%     haralickFeatures = struct; 
   ...
   haralickFeatures = reduceDirFeatures_lung(haralickFeatureAllDirS) ;   % 计算所有glcm特征
