...
## 超参数，文件名
str_image = ['E:\\roi_feat_dose\data\zhouzhengyuan\segment_190420\image\\' ,
             'E:\\roi_feat_dose\data\zhouzhengyuan\segment_190611\image\\' ,
             'E:\\roi_feat_dose\data\zhouzhengyuan\segment_190619\image\\' ]# 要分割图片存放位置
str_image1 = 'IMG0'                       # 文件名
save_str = ['E:\\roi_feat_dose\data\zhouzhengyuan\segment_190420\label_creat\\' ,
            'E:\\roi_feat_dose\data\zhouzhengyuan\segment_190611\label_creat\\' ,
            'E:\\roi_feat_dose\data\zhouzhengyuan\segment_190619\label_creat\\' ] # 分割好图片存放位置
image_end = [220,251,269]        # 图片序列结束
# 超参数，分割效果，调好后较稳定
