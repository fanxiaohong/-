...
roi_x =  [251.3872174] ;  % 单位mm，x方向偏移,变形后减去变形前，通过3Dslicer变形场可计算得到,程序xdose起点-254.426，与DCM文件符号相反
roi_y =  [71.2921724] ;  % 单位mm，y方向偏移，27.9647，与DCM文件一致
roi_z =  [-700.4514466] ;  % 单位mm，y方向偏移，-6.1314，与DCM文件符号相反，顺序相反
