function batchConvert_lung(varargin)
% function batchConvert_lung(sourceDir,destinationDir,zipFlag,mergeScansFlag,file_name)
%
        ...
        elseif isdicom(fullfile(sourceDir,allDirS(dirNum).name))   
            ...
            try
                ...
                if strcmpi(zipFlag,'Yes')
                    ...
                    sourceDirName = file_name ;   % ÎÄ¼þÃüÃû
