...
# feature_start = 1135   # 特征开始的行数0为第一行,对应excel表行特征
mode = 1            # 运行模式，1为保存图片，0为不保存
roi_num = 2          # 分类的类别,0silk，1health
str_data = 'E:\\roi_feat_dose\\result\\feature_lung_silk_health.xls'   # 纹理特征存放位置
str_feat_start = 'E:\\roi_feat_dose\\result\\feat_filt_silk_health.xls'   # 筛选出的特征结果存放位置
pic_str = 'E:\\roi_feat_dose\\result\\plot_silk_health_time\\'
