...
## 超参数，文件名
## 日期 180825,180920,181113,181226,190217
str_image = ['E:\\roi_feat_dose\data\\11.wangziran\segment\segment_181226\image\\'] # 要分割图片存放位置
str_image1 = 'IMG0'                       # 文件名
save_str = ['E:\\roi_feat_dose\data\\11.wangziran\segment\segment_181226\label_creat\\'] # 分割好图片存放位置
...
large_area = 5          # 分割保留最大的区域，step4，zhouzhengyuan190830，设为3单独出
