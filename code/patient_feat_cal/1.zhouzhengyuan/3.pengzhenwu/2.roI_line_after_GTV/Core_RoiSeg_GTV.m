...
num_image = [16,19];         % 变形后GTV图片数量量
num_image_plan = [13];    % 计划的roi的dcm文件数量
roi_x =  [278.64,239.249] ;  % 单位mm，x方向偏移,变形后减去变形前，通过3Dslicer变形场可计算得到,程序xdose起点-254.426，与DCM文件符号相反
roi_y =  [291.688,273.564] ;  % 单位mm，y方向偏移，27.9647，与DCM文件一致
roi_z =  [-139.576,-128.688] ;  % 单位mm，y方向偏移，-6.1314，与DCM文件符号相反，顺序相反
