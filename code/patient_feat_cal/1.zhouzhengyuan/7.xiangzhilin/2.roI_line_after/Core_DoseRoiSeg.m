...
num_image = [94];         % 变形后剂量图片数量
num_image_lungSeg = [165] ;  % 肺分割图片数量,321,165
delta_x =  [7.10551431] ;  % 单位mm，x方向偏移,变形后减去变形前，通过3Dslicer变形场可计算得到,程序xdose起点-254.426，与DCM文件符号相反
delta_y =  [3.071410572] ;  % 单位mm，y方向偏移，27.9647，与DCM文件一致
delta_z =  [130.3739628] ;  % 单位mm，y方向偏移，-6.1314，与DCM文件符号相反，顺序相反
...
plan_dcm_num = 47 ;    % 计划保留的dcm文件数
strName = 'lung';        % 肺名称
image_grid_space_xyplan = 0.976563 ;
image_grid_space_zplan = 5 ;
image_size = 512   ;   % 图片大小
image_grid_space_xy = [0.972656012] ;   %各时间点图像xy方向间隔
image_grid_space_z = [1.249993902] ;      %各时间点图像z方向间隔
