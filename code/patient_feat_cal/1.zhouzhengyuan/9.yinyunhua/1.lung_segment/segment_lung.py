...
## 超参数，文件名
## 日期 180820,180920,181210,190221,190422,190713,191014
str_image = ['E:\\roi_feat_dose\data\\9.yinyunhua\segment\segment_180920\image\\'] # 要分割图片存放位置
str_image1 = 'IMG0'                       # 文件名
save_str = ['E:\\roi_feat_dose\data\\9.yinyunhua\segment\segment_180920\label_creat\\'] # 分割好图片存放位置
image_end = [185]        # 图片序列结束173,185,176,177,187,202,178
# 超参数，分割效果，调好后较稳定
