...
save_file = [file_way,'result/feature_lung_8chenlung_dose55.txt'] ;
...
roi_name = {'lung_seg','dose0_5','dose5_10','dose10_15','dose15_20','dose20_25','dose25_35','dose35_45','dose45_55'};
% filt_name = {'Original'};
data_time = {'190812'} ;
name_time = '190711' ;      % �ļ���ȡ������
