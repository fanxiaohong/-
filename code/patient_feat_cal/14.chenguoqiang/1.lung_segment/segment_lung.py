...
## 超参数，文件名
## 日期180920,181012,181205,190217,190423,190617,190718,190809
str_image = ['E:\\roi_feat_dose\data\\13.luoguiqiu\segment\segment_190809\image\\'] # 要分割图片存放位置
str_image1 = 'IMG0'                       # 文件名
save_str = ['E:\\roi_feat_dose\data\\13.luoguiqiu\segment\segment_190809\label_creat\\'] # 分割好图片存放位置
