...
save_file = [file_way,'result/feature_lung_14cheng10roi180623-180926.txt'] ;
roi_name = {'lung_seg_re','dose0_5','dose5_10','dose10_15','dose15_20','dose20_25','dose25_35','dose35_45','dose45_55','dose55_65'};
filt_name = {'Original','Wavelets_Coif1__HHH','Sobel','Gabor_radius3_sigma0_5_AR1_30_deg_wavelength1'};
% roi_name = {'lung_silk','lung_health'} ;
filt_name = {'Original','Wavelets_Coif1__HHH','Sobel','Gabor_radius3_sigma0_5_AR1_30_deg_wavelength1'};
data_time = {'180623','180730','180926'} ;
name_time = '180403' ;      % 文件读取的设置
