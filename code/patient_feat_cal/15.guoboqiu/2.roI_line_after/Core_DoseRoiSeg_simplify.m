...
patient_name = '15.guoboqiu';
data_time = {'180508','180517'} ;   %   181009
% data_time = {'180623'} ;   %   181009
plan_time = {'180309'} ; % 计划时间
delta_x =  [-34.738,-31.241] ;  % 单位mm，x方向偏移,变形后减去变形前，通过3Dslicer变形场可计算得到,程序xdose起点-254.426，与DCM文件符号相反
delta_y =  [-24.372,-41.899] ;  % 单位mm，y方向偏移，27.9647，与DCM文件一致
delta_z =  [-11.831,-5.38] ;  % 单位mm，y方向偏移，-6.1314，与DCM文件符号相反，顺序相反
