...
## 超参数，文件名
## 日期 180807,180929,181206,190129,190324,190514,190612
str_image = ['E:\\roi_feat_dose\data\\12.caoboyun\segment\segment_181206\image\\'] # 要分割图片存放位置
str_image1 = 'IMG0'                       # 文件名
save_str = ['E:\\roi_feat_dose\data\\12.caoboyun\segment\segment_181206\label_creat\\'] # 分割好图片存放位置
image_end = [500]        # 图片序列结束211,227,253,251,210
# 超参数，分割效果，调好后较稳定
image_start = 1         # 图片序列开始
threshold = -400    # 肺窗阈值，舍去外围不必要部分，step1，-600为luna16所用值,-200为
large_set = 2    # 结节的大小设置，腐蚀，step5
large_set1 = 5    # 使结节附着在肺上，step6,一般团块时用10
large_area = 4          # 分割保留最大的区域，step4，zhouzhengyuan190830，设为3单独出
