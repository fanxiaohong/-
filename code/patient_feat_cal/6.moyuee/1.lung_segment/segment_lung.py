...
str_image = ['E:\\roi_feat_dose\data\\6.moyuee\segment\segment_190113\image\\'] # 要分割图片存放位置
str_image1 = 'IMG0'                       # 文件名
save_str = ['E:\\roi_feat_dose\data\\6.moyuee\segment\segment_190113\label_creat\\'] # 分割好图片存放位置
image_end = [182]        # 图片序列结束171，177，198，181，182
# 超参数，分割效果，调好后较稳定
...
## 流程展示
save_label = save_str[0] +str(50) + '.bmp'
filename = str_image[0] + str_image1 + '0' +str(50) + '.dcm'
ds = pydicom.read_file(filename)  # 读取.dcm文件
numpyImage = ds.pixel_array  # 提取图像信息
data = numpyImage
plt.figure()               # 展示图像灰度图
