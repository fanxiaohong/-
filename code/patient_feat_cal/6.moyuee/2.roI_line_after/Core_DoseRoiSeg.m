...
plan_time = {'180625'} ; % 计划时间
num_image = [118,125,120,118,122];         % 变形后剂量图片数量
num_image_lungSeg = [171,177,198,181,182] ;  % 肺分割图片数量
delta_x =  [-10.523,9.014149666,-27.628,-31.027,-32.818] ;  % 单位mm，x方向偏移,变形后减去变形前，通过3Dslicer变形场可计算得到,程序xdose起点-254.426，与DCM文件符号相反
delta_y =  [-19.91,92.51237488,21.318,-18.61,-34.247] ;  % 单位mm，y方向偏移，27.9647，与DCM文件一致
delta_z =  [-37.951,-89.28623962,-53.655,-42.013,-49.14] ;  % 单位mm，y方向偏移，-6.1314，与DCM文件符号相反，顺序相反
...
plan_dcm_num = 49 ;    % 计划保留的dcm文件数
strName = 'lung';        % 肺名称
image_grid_space_xyplan = 0.976562 ;
image_grid_space_zplan = 5 ;
image_size = 512   ;   % 图片大小
image_grid_space_xy = [0.910156012,0.966796994,0.748046994,0.892578006,0.820312977] ;   %各时间点图像xy方向间隔
image_grid_space_z = [1.25,1.25,1.25,1.249994444444,1.250005525] ;      %各时间点图像z方向间隔
