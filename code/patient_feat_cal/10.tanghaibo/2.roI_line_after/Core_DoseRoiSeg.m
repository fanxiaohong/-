...
plan_time = {'180801'} ; % 计划时间
num_image = [101,102,101,105,124];         % 变形后剂量图片数量
num_image_lungSeg = [268,220,240,209,218] ;  % 肺分割图片数量,321,165
delta_x =  [-3.657,-2.863,0.27246,-29.75414658,-15.865] ;  % 单位mm，x方向偏移,变形后减去变形前，通过3Dslicer变形场可计算得到,程序xdose起点-254.426，与DCM文件符号相反
delta_y =  [-135.318,-13.978,22.91489,-22.18882752,42.783] ;  % 单位mm，y方向偏移，27.9647，与DCM文件一致
delta_z =  [-508.388,49.698,6.37926,69.46958923,-51.174] ;  % 单位mm，y方向偏移，-6.1314，与DCM文件符号相反，顺序相反
...
image_size = 512   ;   % 图片大小
image_grid_space_xy = [0.771484375,0.878906012,0.71875,0.810546994,0.703125] ;   %各时间点图像xy方向间隔
image_grid_space_z = [1.018726592,1.25,1.25,1.25,1.25576] ;      %各时间点图像z方向间隔
