...
## 超参数，文件名
# str_image = ['E:\\roi_feat_dose\data\\3.pengzhenwu\segment\segment_181008\image\\' ,
#              'E:\\roi_feat_dose\data\\3.pengzhenwu\segment\segment_181218\image\\' ,
#              'E:\\roi_feat_dose\data\\3.pengzhenwu\segment\segment_190102\image\\' ,
#              'E:\\roi_feat_dose\data\\3.pengzhenwu\segment\segment_190308\image\\' ,
#              'E:\\roi_feat_dose\data\\3.pengzhenwu\segment\segment_190610\image\\' ,
#              'E:\\roi_feat_dose\data\\3.pengzhenwu\segment\segment_190621\image\\' ,
#              'E:\\roi_feat_dose\data\\3.pengzhenwu\segment\segment_190827\image\\' ]# 要分割图片存放位置
# str_image1 = 'IMG0'                       # 文件名
# save_str = [ 'E:\\roi_feat_dose\data\\3.pengzhenwu\segment\segment_181008\label_creat\\' ,
#              'E:\\roi_feat_dose\data\\3.pengzhenwu\segment\segment_181218\label_creat\\' ,
#              'E:\\roi_feat_dose\data\\3.pengzhenwu\segment\segment_190102\label_creat\\' ,
#              'E:\\roi_feat_dose\data\\3.pengzhenwu\segment\segment_190308\label_creat\\' ,
#              'E:\\roi_feat_dose\data\\3.pengzhenwu\segment\segment_190610\label_creat\\' ,
#              'E:\\roi_feat_dose\data\\3.pengzhenwu\segment\segment_190621\label_creat\\' ,
#              'E:\\roi_feat_dose\data\\3.pengzhenwu\segment\segment_190827\label_creat\\'  ] # 分割好图片存放位置
# image_end = [193,186,195,241,234,196,184]        # 图片序列结束
str_image = ['E:\\roi_feat_dose\data\\3.pengzhenwu\segment\segment_181218\image\\']# 要分割图片存放位置
str_image1 = 'IMG0'                       # 文件名
save_str = [ 'E:\\roi_feat_dose\data\\3.pengzhenwu\segment\segment_181218\label_creat\\' ,] # 分割好
image_end = [186]        # 图片序列结束
# 超参数，分割效果，调好后较稳定
image_start = 1         # 图片序列开始
threshold = -200    # 肺窗阈值，舍去外围不必要部分，step1，-600为luna16所用值
large_set = 2    # 结节的大小设置，腐蚀，step5
large_set1 = 10    # 使结节附着在肺上，step6
large_area = 2          # 分割保留最大的区域，step4，zhouzhengyuan190830，设为3单独出
