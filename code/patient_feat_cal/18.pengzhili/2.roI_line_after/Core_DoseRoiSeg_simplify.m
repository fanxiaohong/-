...
plan_time = {'180308'} ; % 计划时间
delta_x =  [-17.643,5.643775] ;  % 单位mm，x方向偏移,变形后减去变形前，通过3Dslicer变形场可计算得到,程序xdose起点-254.426，与DCM文件符号相反
delta_y =  [-7.907,-5.186144] ;  % 单位mm，y方向偏移，27.9647，与DCM文件一致
delta_z =  [-85.2,-33.933283] ;  % 单位mm，y方向偏移，-6.1314，与DCM文件符号相反，顺序相反
