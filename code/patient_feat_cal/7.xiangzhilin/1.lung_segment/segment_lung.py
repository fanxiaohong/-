...
## 超参数，文件名
## 日期 181009,181109
str_image = ['E:\\roi_feat_dose\data\\7.xiangzhilin\segment\segment_181209\image\\'] # 要分割图片存放位置
str_image1 = 'IMG0'                       # 文件名
save_str = ['E:\\roi_feat_dose\data\\7.xiangzhilin\segment\segment_181209\label_creat\\'] # 分割好图片存放位置
image_end = [175]        # 图片序列结束165，321
# 超参数，分割效果，调好后较稳定
